...
import (
	"context"
	dpfm_api_caller "data-platform-api-business-partner-exconf-supplier-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-business-partner-exconf-supplier-rmq-kube/config"
...
func dataCallProcess(
	...
	out.BusinessPartnerSupplier = *exist
	l.JsonParseOut(out)
}
